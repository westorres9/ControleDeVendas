...
public class TeamService {
	...
	public TeamDTO insert(TeamDTO dto) {
		...
		if (user.hasRole("ROLE_MANAGER")) {
			...
			entity.setImgUrl(
					"https://user-images.githubusercontent.com/91570669/227974974-0aa117cf-b9d2-4787-a5dc-36b539d538c0.png");
	...
	@Transactional
	public String updateTeamImage(Long id, MultipartFile file) {
		try {
			Team entity = repository.getOne(id);
